...
$text = "<div>$file is available</div>";

if( false == file_exists($file)) {
  $text = "<div>$file not available</div>";
}
//sleep(5);
echo $text;
...
//         echo '<img data-src="' . $imgfile . '" class="c_img_thumb" alt="' . $file . '" draggable="true" ondragstart="handleImgDragStart(event)">';
